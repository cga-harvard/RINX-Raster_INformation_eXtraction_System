...
ST_VALUE(b.rast, ST_Transform(ST_SetSRID( ST_Point(a.longitude, a.latitude), 4326), 4269)) as tmin
from addresses a
...
Copy(Select * from results_tmin) TO '/pgdata/results/results_tmin.csv';