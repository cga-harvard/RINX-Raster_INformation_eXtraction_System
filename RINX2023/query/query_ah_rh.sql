...
Update temp set RH=ROUND(100*(EXP((17.625*tdmean)/(243.04+tdmean))/EXP((17.625*tmean)/(243.04+tmean)))::NUMERIC, 4);
Update temp SET AH=ROUND((6.112*EXP((17.67*tmean)/(tmean +243.5)) * RH * 2.1674)/(273.15+ tmean)::NUMERIC, 4);
