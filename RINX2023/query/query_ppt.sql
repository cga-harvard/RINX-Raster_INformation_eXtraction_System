...
ROUND(ST_VALUE(b.rast, ST_Transform(ST_SetSRID(a.geom, 4326), 4269))::NUMERIC, 5) AS ppt
from addresses a
inner join pptunion b
ON
ST_Intersects(ST_Envelope(b.rast), ST_Transform(ST_SetSRID(a.geom, 4326), 4269)) = 't'
